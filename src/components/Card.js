      ...
      {isOpen && (
        <div className="steps">
          <div className="numbers">
            <div className={`num ${step >= 0 ? "active" : ""}`}>{step + 1}</div>
          </div>
          <div className="message">
            {
              <div className="card">
                <div className="tour-name">{data[step].name}</div>
                <div>
                  <div className="img-container">
                    <img
                      className="img"
                      src={`./../assets/images/tour-1-1.jpg`}
                      alt="tour"
                    />
                    <div className="others">
                      <ul>
                        <li>Tour duration: {data[step].duration}</li>
                        <li>Tour maxgroupSize: {data[step].maxGroupSize}</li>
                        <li>Tour difficulty: {data[step].difficulty}</li>
                        <li>
                          Tour ratingsAverage: {data[step].ratingsAverage}
                        </li>
                        <li>
                          Tour ratingsQuantity: {data[step].ratingsQuantity}
                        </li>
                        <li>
                          Tour price:
                          <span className="price">$ {data[step].price}</span>
                        </li>
                      </ul>
                    </div>
                  </div>
